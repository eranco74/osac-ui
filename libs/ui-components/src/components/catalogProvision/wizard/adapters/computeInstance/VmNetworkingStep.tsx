...
export const VmNetworkingStep = ({ catalogItem }: Props) => {
  ...
  useEffect(() => {
    ...
    if (securityGroupOptions.length === 1 && !values.spec.networking.securityGroupId) {
      void setFieldValue('spec.networking.securityGroupId', securityGroupOptions[0].value);
    }
  }, [
  ...
  useEffect(() => {
    ...
    if (previous && previous !== virtualNetworkId) {
      ...
      void setFieldValue('spec.networking.securityGroupId', '');
    }
      ...
      <Stack hasGutter>
        <StackItem>
          ...
          <SubtleContent component="p">
            {t('catalogProvision.steps.networking.selectCatalogItem')}
          </SubtleContent>
        </StackItem>
      </Stack>
    );
  ...
  return (
    <Stack hasGutter>
      <StackItem>
        ...
        <SubtleContent component="p">{t('catalogProvision.steps.networking.intro')}</SubtleContent>
      </StackItem>
      {listError ? (
        <StackItem>
